...
运行方式:
    uv run python manual_tests/ppt_get_slide_info_e2e/test_basic_info.py --test 1
    uv run python manual_tests/ppt_get_slide_info_e2e/test_basic_info.py --test all
    uv run python manual_tests/ppt_get_slide_info_e2e/test_basic_info.py --list
"""
...
from manual_tests.ppt_test_helpers import ppt_get_slide_info
