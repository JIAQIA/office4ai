...
```bash
uv run python manual_tests/ppt_update_text_box_e2e/test_text_box_update.py --test 1
uv run python manual_tests/ppt_update_text_box_e2e/test_text_box_update.py --test all
uv run python manual_tests/ppt_update_text_box_e2e/test_text_box_update.py --list
```
