...
使用方式:
    from manual_tests.ppt_e2e_base import PPTTestRunner, PresentationReader
...
def dump_ppt_ui_hierarchy() -> None:
    ...
    Usage:
        python -c "from manual_tests.ppt_e2e_base import dump_ppt_ui_hierarchy; dump_ppt_ui_hierarchy()"
    """
    if platform.system() != "Darwin":
        print("仅支持 macOS")
        return
