...
```bash
uv run python manual_tests/ppt_update_image_e2e/test_image_update.py --test 1
uv run python manual_tests/ppt_update_image_e2e/test_image_update.py --test all
uv run python manual_tests/ppt_update_image_e2e/test_image_update.py --list
```
